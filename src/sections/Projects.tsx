...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Research-backed LLM evaluation framework — pairwise and pointwise scoring with position bias, verbosity bias, and self-enhancement detection. Based on MT-Bench, G-Eval, and Prometheus. FastAPI REST API, Streamlit UI, and Python SDK.',
      image: '/project-rag.jpg',
      tech: ['Python', 'FastAPI', 'Streamlit', 'OpenAI', 'Anthropic', 'SQLAlchemy', 'Docker'],
